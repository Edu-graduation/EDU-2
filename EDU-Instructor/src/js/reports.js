...
//   const { data, error } = await supaClient.from("activity").select("*");
//   if (error) throw error;
//   return data;
// }
...
// // 2. Initialize the chart modal functionality
...
//   });
// }
// // 3. Function to open a chart in the modal
// // function openChartInModal(chartId) {
// //   // Get the chart instance
// //   const chart = charts[getChartInstanceName(chartId)];
// //   if (!chart) {
...
//     performanceTrendChart: "Performance Trend Analysis",
//   };
...
//     (_, idx) => completedData[idx] < 70
//   );
//   console.log(lowCompletionAssignments);

//   if (lowCompletionAssignments.length > 0) {
//     insights += `<li><strong>Assignments with <70% Completion:</strong> ${lowCompletionAssignments.length} assignments</li>`;
//   }
...
//   insights += `<li><strong>Assignment Completion Trend:</strong> ${
//     assignmentTrend > 0 ? "Positive" : "Negative"
//   } (${Math.abs(assignmentTrend).toFixed(1)}% ${
//     assignmentTrend > 0 ? "increase" : "decrease"
//   })</li>`;
//   insights += `<li><strong>Quiz Performance Trend:</strong> ${
//     quizTrend > 0 ? "Positive" : "Negative"
//   } (${Math.abs(quizTrend).toFixed(1)} points ${
//     quizTrend > 0 ? "increase" : "decrease"
//   })</li>`;
...
// // Update the generateChartInsights function to include proper action buttons
...
// // Add the modal initialization to the main initializeReports function
// // const originalInitializeReports = initializeReports;
// // initializeReports = async function() {
// //   await originalInitializeReports();
// //   initChartModal();
// //   makeChartsClickable();
